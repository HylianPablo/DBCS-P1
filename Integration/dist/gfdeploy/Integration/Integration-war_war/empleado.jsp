...
<html>
    ...
    <body>
        ...
        <form action="controladorNuevaConfiguracion" name="ejemplo" method="post">
            ...
            <input type="submit" value="Nueva Configuracion" name="envioNC"><br><br>
            <input type="submit" value="Editar Configuracion" name="envioEC"><br><br>
            <input type="reset" value="Vaciar">
            <input type="submit" value="Salir" name="envioSalir"><br><br>
    </form>
    </body>
</html>
